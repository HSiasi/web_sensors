-- ----------------------------------------------------
-- Location Application Configuration Object
...
-- ----------------------------------------------------
-- Resource IDs for LwM2M Location Application Configuration Object
-- ----------------------------------------------------

-- Lua does not have any concept of constants so
-- be careful with these.

local RES_M_WIFI_SCAN_REQUIRED = 1
local RES_M_GNSS_REQUIRED_FOR_LOCATION_FIX = 2
local RES_M_GNSS_LOCATION_RADIUS = 3
local RES_M_GNSS_ALLOTTED_LOCATION_ESTABLISHMENT_TIME = 4

-- ----------------------------------------------------
-- Globals
-- ----------------------------------------------------
object_location_application_configuration = {}
object_location_application_configuration.objectId = 33053
object_location_application_configuration.name = "object_location_application_configuration"

-- Add this object to the global object table
lwm2m_object_tbl_add(object_location_application_configuration.objectId, object_location_application_configuration.name)

local object_table = {

   Name = "Location Application Configuration",
   ObjectId = "33053",
   LwM2MVersion = "1.0",
   ObjectVersion = "1.0",
...
local resource_tbl = {
   ...
   [RES_M_WIFI_SCAN_REQUIRED] = {
      Name = "WiFi Scan Required",
      Operations = "RW",
      MultipleInstances = "Single",
      Mandatory = "Mandatory",
      Type = "Boolean",
   ...
   [RES_M_GNSS_REQUIRED_FOR_LOCATION_FIX] = {
      Name = "GNSS Required for Location Fix",
      Operations = "RW",
      MultipleInstances = "Single",
      Mandatory = "Mandatory",
      Type = "Boolean",
   ...
   [RES_M_GNSS_LOCATION_RADIUS] = {
      Name = "GNSS Location Radius",
      Operations = "RW",
      MultipleInstances = "Single",
      Mandatory = "Mandatory",
      Type = "Float",
   ...
   [RES_M_GNSS_ALLOTTED_LOCATION_ESTABLISHMENT_TIME] = {
      Name = "GNSS Allotted Location Establishment Time",
      Operations = "RW",
      MultipleInstances = "Single",
      Mandatory = "Mandatory",
      Type = "Integer",
...
-- @return  None
-- ----------------------------------------------------
function object_location_application_configuration.load(t)
   object_table = t
end
...
-- ----------------------------------------------------
function object_location_application_configuration.get_resource_table()
   return resource_tbl
end
...
-- ----------------------------------------------------
function object_location_application_configuration.get_resource_type(res)
...
-- ----------------------------------------------------
function object_location_application_configuration.get_object_table()
   return object_table
end
...
-- ----------------------------------------------------
function object_location_application_configuration.delete (inst)
...
-- ----------------------------------------------------
function object_location_application_configuration.write (inst, res, iface, replace, value, userdata)
...
--            a Lua Table.
-------------------------------------------------------
function object_location_application_configuration.read (inst, res, dm)
...
-- @return  COAP response code
-------------------------------------------------------
function object_location_application_configuration.discover (inst, res)
...
-- @return COAP response code
-------------------------------------------------------
function object_location_application_configuration.create (inst)
...
-- return the object
return object_location_application_configuration
